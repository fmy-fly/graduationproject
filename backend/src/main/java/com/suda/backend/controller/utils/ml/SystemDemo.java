...
public class SystemDemo {
	...
	public J48 model() throws Exception {						
		...
		options[0] = "-U"; // ���޼�
		tree1 = new J48(); // J48����������
		tree1.setOptions(options);// ����ѡ��
		tree1.buildClassifier(train1);// ����������	
		return tree1;
	}
	public Instances TrainLoader() throws Exception {
		train1 = DataSource.read("C:\\Users\\17914\\Desktop\\ML-ATIC-master\\ML-ATIC-master\\data\\TrainAndTest\\Train.arff");
		train1.setClassIndex(train1.numAttributes() - 1);
		return train1;
	}
	public Instances TestLoader() throws Exception {
		test1  = DataSource.read("C:\\Users\\17914\\Desktop\\ML-ATIC-master\\ML-ATIC-master\\data\\TrainAndTest\\Test.arff");
	...
	public  String predict() throws Exception {	
		TrainTree=new MyEvaluation();	
		Instances demo = DataSource.read("C:\\Users\\17914\\Desktop\\ML-ATIC-master\\ML-ATIC-master\\data\\TrainAndTest\\Train.arff");
		...
		// ������train�Ŀ�instances����race��Ϊ�������instance�Ĵ���
